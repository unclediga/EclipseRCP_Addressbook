...
public class AddressEditorPart extends WiredModelDataBindingEditorPart<AddressIdEditorInput, Address> {
	...
	protected void onCreateUi(Composite parent) {
		...
		GridDataFactory.fillDefaults().span(1, 5)
				.hint(AddressBookEditing.GRAVATAR_SIZE, AddressBookEditing.GRAVATAR_SIZE).align(SWT.LEFT, SWT.TOP)
				.indent(20, 0).applyTo(lblGravatar);
	...
	public void init(IEditorSite site, IEditorInput input) throws PartInitException {
		...
		ServiceReference<?> serviceReference = bundleContext.getServiceReference(IAddressService.class.getName());
		bindAddressService((IAddressService) bundleContext.getService(serviceReference));
		System.out.println("Creating: " + this.getClass().getName());
		System.out.println("Service is : " + this.addressService);
	};
